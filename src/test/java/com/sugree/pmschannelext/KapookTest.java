...
public class KapookTest {
	private static final String CH_PATH = "src/main/resources/channels/kapook.ch";
	...
	public void parse() throws Exception {
		...
		assertNotNull(ch);
		assertEquals("Kapook", ch.getName());
		ch.discoverChildren();
	...
	public void category1() {
		...
		ChannelPMSItem c1 = (ChannelPMSItem) c0.getChildren().get(3);
		System.out.println(c1);
		c1.discoverChildren();
		System.out.println(c1.getChildren());
		assertEquals(1, c1.getChildren().size());
	...
	public void category2() {
		...
		ChannelPMSFolder c0 = (ChannelPMSFolder) f.getChildren().get(5);
		System.out.println(c0);
		c0.discoverChildren();
		System.out.println(c0.getChildren());
		assertEquals(29, c0.getChildren().size());
