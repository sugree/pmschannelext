...
public class SanookTest {
	private static final String CH_PATH = "src/main/resources/channels/sanook.ch";
	...
	public void parse() throws Exception {
		...
		assertNotNull(ch);
		assertEquals("Sanook", ch.getName());
		ch.discoverChildren();
	...
	public void category0() {
		...
		assertEquals(20, c0.getChildren().size());
